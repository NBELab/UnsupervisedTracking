...
if __name__ == "__main__":
    ...
    parser.add_argument("path", help="txt file to extract or directory containing txt files" ,default="D:/siamEvents/real_event_dataset/events")
    parser.add_argument("--output_dir", default="D:/siamEvents/real_event_dataset/events/bags", help="Folder where to extract the data")
