...
class BaseVoxelDataset(Dataset):
    ...
    def __init__(self, data_path, transforms={}, sensor_resolution=None, num_bins=3,
                 voxel_method=None, max_length=None, combined_voxel_channels=True,
                 filter_hot_events=False,neg_events=False):
        """
...
class SequenceDataset(Dataset):
    ...
    def __init__(self, data_root, sequence_length, dataset_type='MemMapDataset',
            ...
            proba_pause_when_paused=0.0, proba_neg_events = 0.0,
            proba_rev_events = 0.0, proba_fast_back = 0.0,random_search = False, normalize_image=False,
